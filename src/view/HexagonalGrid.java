...
public class HexagonalGrid extends JFrame {
    ...
    private String[] nomsJoueurs = new String[4]; // Tableau pour stocker les noms des joueurs
...
>>>>>>> Stashed changes
        ...
        showBoardButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                askForPlayerNames(); // Demande les noms des joueurs
            }
        });
    ...
    private void askForPlayerNames() {
        for (int i = 0; i < 4; i++) {
            String playerName = JOptionPane.showInputDialog("Entrez le nom du joueur " + (i + 1));
            if (playerName != null && !playerName.isEmpty()) {
                nomsJoueurs[i] = playerName;
            } else {
                // Si aucun nom n'est saisi, utilise un nom par défaut
                nomsJoueurs[i] = "Joueur " + (i + 1);
            }
        }
        startGame(); // Commence le jeu après avoir demandé les noms des joueurs
    }
    ...
    private class ImagePanel extends JPanel {
        ...
        private void drawTourAndPlayerInfo(Graphics g) {
            ...
            String joueurText = "Nom joueur : " + nomsJoueurs[currentPlayerIndex];
